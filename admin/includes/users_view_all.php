        ...
        <tbody>
            ...
            { ?> 
                <tr>
                    ...
                    <td> <a href="users.php?user=edit&who=<?=$row['user_id']; ?>">  <button class="btn btn-dark btn-sm" type="button">  Edit <i class="fas fa-pencil-alt    "></i>  </button> </a> </td>
    ...
    <div id="pagination_div"> 
        ...
        if($all_posts !== 0)
        {
                ...
                <ul class="pager nav" id="pagination_list">
                    ...
                    <li class="previous">
                        <a href="users.php?page=<?php echo $previous ?>" class='previous'>&larr; Previous </a>
                    </li> 
                    ...
                    for($i = 1; $i <= $count; $i++ )
                    {
                        if($page == $i)
                        {
                            echo " <li> <a class='page_number active' href='users.php?page=$i'> $i </a> </li> ";
                        }
                        else
                        {
                            echo " <li  > <a class='page_number'  href='users.php?page=$i'> $i </a> </li> ";
                        }
                    }
                    ...
                    <li class="next">
                        <a href="users.php?page=<?php echo $next; ?>" class="next">Next &rarr;</a>
                    </li>
