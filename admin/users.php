...
?>
  ...
  <h2 class="text-center order_title"> <a id="products_title" href="users.php"> Registered users </a> </h2>
      ...
      { ?>
          ...
          <div class="text-center"> 
            ...
            { ?>
                ...
                <div id="add_new_user_btn">
                    <a class="btn btn-success" href="users.php?user=add" >Add a new user</a> 
                </div> <br>  <?php 
            } ?>
          ...
          <div class="text-center">  
            ...
            <?php  //  show default table or form to include in the page
              ...
              {
                  include "includes/users_view_all.php";
              } ?>
